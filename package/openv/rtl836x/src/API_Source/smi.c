...
extern void MDIO_WRITE(int regID,int data);
extern void MDIO_READ(int regID,int* pData);

/* MDC/MDIO, redefine/implement the following Macro */
#define MDC_MDIO_WRITE(preamableLength, phyID, regID, data) MDIO_WRITE(regID,data) 
#define MDC_MDIO_READ(preamableLength, phyID, regID, pData) MDIO_READ(regID,pData)
...
extern  void rtlglue_drvMutexLock(void);
extern  void rtlglue_drvMutexUnlock(void);
